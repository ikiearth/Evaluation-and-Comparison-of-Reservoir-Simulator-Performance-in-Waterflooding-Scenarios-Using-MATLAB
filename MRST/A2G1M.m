...
Lx = Nx * 200 * feet_to_meter;  % Convert from Feet to Meters
Ly = Ny * 200 * feet_to_meter;  % Convert from Feet to Meters
...
W = verticalWell(W, G, rock, ...
    25, 25, 1:3, ...                      % Location: row (I=1), column (J=1), full perforation (K=[])
...
W = verticalWell(W, G, rock, ...
    50, 1, 1:3, ...                     % Location: row (I=25), column (J=25), perforation at K=1
...
W = verticalWell(W, G, rock, ...
    1, 50, 1:3, ...                     % Location: row (I=25), column (J=25), perforation at K=1
...
W = verticalWell(W, G, rock, ...
    50, 50, 1:3, ...                    % Location: row (I=25), column (J=25), perforation at K=1
