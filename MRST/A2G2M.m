...
% Grid dimensions
Nx = 60;  % Number of divisions in the x-direction
Ny = 60;  % Number of divisions in the y-direction
Nz = 3;   % Number of divisions in the z-direction

% Length calculations (in meters)
Lx = Nx * 166.6666666667 * feet_to_meter;  % Convert from Feet to Meters
Ly = Ny * 166.6666666667 * feet_to_meter;  % Convert from Feet to Meters
...
W = verticalWell(W, G, rock, ...
    30, 30, 1:3, ...                      % Location: row (I=1), column (J=1), full perforation (K=[])
...
W = verticalWell(W, G, rock, ...
    60, 1, 1:3, ...                     % Location: row (I=25), column (J=25), perforation at K=1
...
W = verticalWell(W, G, rock, ...
    1, 60, 1:3, ...                     % Location: row (I=25), column (J=25), perforation at K=1
...
W = verticalWell(W, G, rock, ...
    60, 60, 1:3, ...                    % Location: row (I=25), column (J=25), perforation at K=1
